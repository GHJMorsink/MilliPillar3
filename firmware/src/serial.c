...
/* Note: this source can be used for ATMega8 / 16 / 32, or for ATMega88, ATMega168, ATMega328 */
...
#define BAUDSETTING  (5)   /* Select speed: 38400 */
...
void vSerialInit( void )
{
	...
	iTxInPtr = 0;
	iTxOutPtr = 0;
   vSetBaud( BAUDSETTING );          /* set a default baudrate */
	uTxOverflow = 0;
	uRxOverflow = 0;
}
#endif
